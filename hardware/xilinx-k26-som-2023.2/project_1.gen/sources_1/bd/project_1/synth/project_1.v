...
module hier_dpu_clk_imp_1CTNM6E
   (CLK,
    DPU_CLK,
    DSP_CLK,
    LOCKED,
  ...
  project_1_dpu_clk_wiz_0 dpu_clk_wiz
       (.clk_dpu(dpu_clk_wiz_clk_dpu),
        ...
        .resetn(RSTn_1));
  project_1_rst_gen_clk_0 rst_gen_clk
       (.aux_reset_in(1'b1),
  ...
  project_1_rst_gen_clk_dsp_0 rst_gen_clk_dsp
       (.aux_reset_in(1'b1),
        .dcm_locked(dpu_clk_wiz_locked),
        .ext_reset_in(RSTn_1),
        .mb_debug_sys_rst(1'b0),
...
module hier_dpu_ghp_imp_1I7UWO4
   (CLK,
  ...
  wire [0:0]dpu_intc_M_AXI_HP0_FPD_M00_AXI_ARLOCK;
  ...
  wire [0:0]dpu_intc_M_AXI_HP0_FPD_M00_AXI_ARUSER;
  ...
  wire [0:0]dpu_intc_M_AXI_HP0_FPD_M00_AXI_AWLOCK;
  ...
  wire [0:0]dpu_intc_M_AXI_HP0_FPD_M00_AXI_AWUSER;
  ...
  wire [0:0]dpu_intc_M_AXI_HP1_FPD_M00_AXI_ARLOCK;
  ...
  wire [0:0]dpu_intc_M_AXI_HP1_FPD_M00_AXI_ARUSER;
  ...
  wire [0:0]dpu_intc_M_AXI_HP1_FPD_M00_AXI_AWLOCK;
  ...
  wire [0:0]dpu_intc_M_AXI_HP1_FPD_M00_AXI_AWUSER;
  ...
  wire [0:0]dpu_intc_M_AXI_LPD_M00_AXI_ARLOCK;
  ...
  wire [0:0]dpu_intc_M_AXI_LPD_M00_AXI_AWLOCK;
  ...
  wire [127:0]dpu_intc_M_AXI_LPD_M00_AXI_RDATA;
  ...
  wire [127:0]dpu_intc_M_AXI_LPD_M00_AXI_WDATA;
  wire dpu_intc_M_AXI_LPD_M00_AXI_WLAST;
  wire dpu_intc_M_AXI_LPD_M00_AXI_WREADY;
  wire [15:0]dpu_intc_M_AXI_LPD_M00_AXI_WSTRB;
  ...
  assign M_AXI_HP0_FPD_arlock[0] = dpu_intc_M_AXI_HP0_FPD_M00_AXI_ARLOCK;
  ...
  assign M_AXI_HP0_FPD_aruser[0] = dpu_intc_M_AXI_HP0_FPD_M00_AXI_ARUSER;
  ...
  assign M_AXI_HP0_FPD_awlock[0] = dpu_intc_M_AXI_HP0_FPD_M00_AXI_AWLOCK;
  ...
  assign M_AXI_HP0_FPD_awuser[0] = dpu_intc_M_AXI_HP0_FPD_M00_AXI_AWUSER;
  ...
  assign M_AXI_HP1_FPD_arlock[0] = dpu_intc_M_AXI_HP1_FPD_M00_AXI_ARLOCK;
  ...
  assign M_AXI_HP1_FPD_aruser[0] = dpu_intc_M_AXI_HP1_FPD_M00_AXI_ARUSER;
  ...
  assign M_AXI_HP1_FPD_awlock[0] = dpu_intc_M_AXI_HP1_FPD_M00_AXI_AWLOCK;
  ...
  assign M_AXI_HP1_FPD_awuser[0] = dpu_intc_M_AXI_HP1_FPD_M00_AXI_AWUSER;
  ...
  assign M_AXI_LPD_arlock[0] = dpu_intc_M_AXI_LPD_M00_AXI_ARLOCK;
  ...
  assign M_AXI_LPD_awlock[0] = dpu_intc_M_AXI_LPD_M00_AXI_AWLOCK;
  ...
  assign M_AXI_LPD_wdata[127:0] = dpu_intc_M_AXI_LPD_M00_AXI_WDATA;
  assign M_AXI_LPD_wlast = dpu_intc_M_AXI_LPD_M00_AXI_WLAST;
  assign M_AXI_LPD_wstrb[15:0] = dpu_intc_M_AXI_LPD_M00_AXI_WSTRB;
  ...
  assign dpu_intc_M_AXI_LPD_M00_AXI_RDATA = M_AXI_LPD_rdata[127:0];
  ...
  project_1_dpu_intc_M_AXI_HP0_FPD_0 dpu_intc_M_AXI_HP0_FPD
       (.ACLK(CLK_1),
        .ARESETN(RSTn_INTC_1),
  ...
  project_1_dpu_intc_M_AXI_HP1_FPD_0 dpu_intc_M_AXI_HP1_FPD
       (.ACLK(CLK_1),
        .ARESETN(RSTn_INTC_1),
        .M00_ACLK(GHP_CLK_I_1),
        .M00_ARESETN(GHP_RSTn_1),
  ...
  project_1_dpu_intc_M_AXI_LPD_0 dpu_intc_M_AXI_LPD
       (.ACLK(CLK_1),
        .ARESETN(RSTn_INTC_1),
        .M00_ACLK(GHP_CLK_I_1),
        .M00_ARESETN(GHP_RSTn_1),
...
module hier_dpu_imp_18VFY5X
  ...
  assign Conn3_RDATA = M_AXI_LPD_rdata[127:0];
  ...
  assign M_AXI_HP0_FPD_arlock[0] = Conn1_ARLOCK;
  ...
  assign M_AXI_HP0_FPD_aruser[0] = Conn1_ARUSER;
  ...
  assign M_AXI_HP0_FPD_awlock[0] = Conn1_AWLOCK;
  ...
  assign M_AXI_HP0_FPD_awuser[0] = Conn1_AWUSER;
  ...
  assign M_AXI_HP1_FPD_arlock[0] = Conn2_ARLOCK;
  ...
  assign M_AXI_HP1_FPD_aruser[0] = Conn2_ARUSER;
  ...
  assign M_AXI_HP1_FPD_awlock[0] = Conn2_AWLOCK;
  ...
  assign M_AXI_HP1_FPD_awuser[0] = Conn2_AWUSER;
  ...
  assign M_AXI_LPD_arlock[0] = Conn3_ARLOCK;
  ...
  assign M_AXI_LPD_awlock[0] = Conn3_AWLOCK;
  ...
  assign M_AXI_LPD_wdata[127:0] = Conn3_WDATA;
  assign M_AXI_LPD_wlast = Conn3_WLAST;
  assign M_AXI_LPD_wstrb[15:0] = Conn3_WSTRB;
  ...
  project_1_DPUCZDX8G_0 DPUCZDX8G
       (.dpu0_interrupt(DPUCZDX8G_dpu0_interrupt),
        ...
        .s_axi_arlock({1'b0,S_AXI_1_ARLOCK}),
        ...
        .s_axi_awlock({1'b0,S_AXI_1_AWLOCK}),
  ...
  hier_dpu_clk_imp_1CTNM6E hier_dpu_clk
       (.CLK(CLK_1),
  ...
  hier_dpu_ghp_imp_1I7UWO4 hier_dpu_ghp
       (.CLK(hier_dpu_clk_DPU_CLK),
        ...
        .RSTn_INTC(hier_dpu_clk_RSTn_INTC),
        .RSTn_PERI(hier_dpu_clk_RSTn_PERI));
  hier_dpu_irq_imp_128HJ7V hier_dpu_irq
       (.INTR(hier_dpu_irq_INTR),
        .In0(DPUCZDX8G_dpu0_interrupt));
endmodule

module hier_dpu_irq_imp_128HJ7V
   (INTR,
    In0);
  output [0:0]INTR;
  input [0:0]In0;
...
module project_1
  ...
  wire [0:0]hier_dpu_M_AXI_HP0_FPD_ARLOCK;
  ...
  wire [0:0]hier_dpu_M_AXI_HP0_FPD_ARUSER;
  ...
  wire [0:0]hier_dpu_M_AXI_HP0_FPD_AWLOCK;
  ...
  wire [0:0]hier_dpu_M_AXI_HP0_FPD_AWUSER;
  ...
  wire [0:0]hier_dpu_M_AXI_HP1_FPD_ARLOCK;
  ...
  wire [0:0]hier_dpu_M_AXI_HP1_FPD_ARUSER;
  ...
  wire [0:0]hier_dpu_M_AXI_HP1_FPD_AWLOCK;
  ...
  wire [0:0]hier_dpu_M_AXI_HP1_FPD_AWUSER;
  ...
  wire [0:0]hier_dpu_M_AXI_LPD_ARLOCK;
  ...
  wire [0:0]hier_dpu_M_AXI_LPD_AWLOCK;
  ...
  wire [127:0]hier_dpu_M_AXI_LPD_RDATA;
  ...
  wire [127:0]hier_dpu_M_AXI_LPD_WDATA;
  wire hier_dpu_M_AXI_LPD_WLAST;
  wire hier_dpu_M_AXI_LPD_WREADY;
  wire [15:0]hier_dpu_M_AXI_LPD_WSTRB;
  ...
  project_1_dpu_concat_irq_0 dpu_concat_irq
       (.In0(hier_dpu_INTR),
        .dout(dpu_concat_irq_dout));
  hier_dpu_imp_18VFY5X hier_dpu
  ...
  project_1_rst_gen_ghp_0 rst_gen_ghp
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  project_1_rst_gen_reg_0 rst_gen_reg
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(zynq_ultra_ps_e_pl_resetn0),
        .mb_debug_sys_rst(1'b0),
  ...
  project_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e
...
module project_1_dpu_intc_M_AXI_HP0_FPD_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_ARLOCK;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_ARUSER;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_AWLOCK;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_AWUSER;
  ...
  assign M00_AXI_arlock[0] = s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_ARLOCK;
  ...
  assign M00_AXI_aruser[0] = s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_ARUSER;
  ...
  assign M00_AXI_awlock[0] = s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_AWLOCK;
  ...
  assign M00_AXI_awuser[0] = s00_couplers_to_dpu_intc_M_AXI_HP0_FPD_AWUSER;
  ...
  s00_couplers_imp_8NA42J s00_couplers
...
module project_1_dpu_intc_M_AXI_HP1_FPD_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_ARLOCK;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_ARUSER;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_AWLOCK;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_AWUSER;
  ...
  assign M00_AXI_arlock[0] = s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_ARLOCK;
  ...
  assign M00_AXI_aruser[0] = s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_ARUSER;
  ...
  assign M00_AXI_awlock[0] = s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_AWLOCK;
  ...
  assign M00_AXI_awuser[0] = s00_couplers_to_dpu_intc_M_AXI_HP1_FPD_AWUSER;
  ...
  s00_couplers_imp_VJ71AY s00_couplers
...
module project_1_dpu_intc_M_AXI_LPD_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_LPD_ARLOCK;
  ...
  wire [0:0]s00_couplers_to_dpu_intc_M_AXI_LPD_AWLOCK;
  ...
  wire [127:0]s00_couplers_to_dpu_intc_M_AXI_LPD_RDATA;
  ...
  wire [127:0]s00_couplers_to_dpu_intc_M_AXI_LPD_WDATA;
  wire s00_couplers_to_dpu_intc_M_AXI_LPD_WLAST;
  wire s00_couplers_to_dpu_intc_M_AXI_LPD_WREADY;
  wire [15:0]s00_couplers_to_dpu_intc_M_AXI_LPD_WSTRB;
  ...
  assign M00_AXI_arlock[0] = s00_couplers_to_dpu_intc_M_AXI_LPD_ARLOCK;
  ...
  assign M00_AXI_awlock[0] = s00_couplers_to_dpu_intc_M_AXI_LPD_AWLOCK;
  ...
  assign M00_AXI_wdata[127:0] = s00_couplers_to_dpu_intc_M_AXI_LPD_WDATA;
  assign M00_AXI_wlast = s00_couplers_to_dpu_intc_M_AXI_LPD_WLAST;
  assign M00_AXI_wstrb[15:0] = s00_couplers_to_dpu_intc_M_AXI_LPD_WSTRB;
  ...
  assign s00_couplers_to_dpu_intc_M_AXI_LPD_RDATA = M00_AXI_rdata[127:0];
  ...
  s00_couplers_imp_120WWF s00_couplers
...
module s00_couplers_imp_120WWF
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
...
module s00_couplers_imp_8NA42J
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
...
module s00_couplers_imp_VJ71AY
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
